...
public class StackedBarChartViewModelTests extends GroovyTestCase {
    ...
    void testGetDataTable() {
        ...
        resultAccessor.demand.getMean(1..2000) {SimulationRun simulationRun, int periodIndex, String path, String s, String s2 -> 0}
        ...
        resultAccessor.use {
            StackedBarChartViewModel model = new StackedBarChartViewModel("test", new SimulationRun(name: "testRun", periodCount: 1000), [node])
