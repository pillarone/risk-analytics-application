...
target(runResultNavigator: "The application start target") {
    try {
        ...
        new GroovyShell(app.classLoader, new Binding(app: app, ctx: ctx)).evaluate '''
            ...
            import org.pillarone.riskanalytics.application.ui.resultnavigator.StandaloneResultNavigatorLauncher

            GrailsConfigUtils.executeGrailsBootstraps(app,ctx,null)
            StandaloneResultNavigatorLauncher.launch()
        '''
    } catch (Exception e) {
