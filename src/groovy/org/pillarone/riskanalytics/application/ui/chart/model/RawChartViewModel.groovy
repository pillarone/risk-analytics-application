 ...
 * @author fouad jaada
 */
abstract class RawChartViewModel extends KernelEstimatorChartViewModel {
...
- and not, as described in many papers, the dimension of its square (e.g. like the variance).  */
    ...
    public RawChartViewModel() {
    }

    public RawChartViewModel(String title, SimulationRun simulationRun, List<SimpleTableTreeNode> nodes, double insetHeight) {
