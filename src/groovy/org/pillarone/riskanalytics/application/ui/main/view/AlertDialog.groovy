...
class AlertDialog {
    ...
    public AlertDialog(ULCTableTree tree, def selectedItem, String title, String message, Closure okAction) {
        this.tree = tree
        this.title = title
    ...
    private void attachListeners() {
        ...
        okButton.addActionListener([actionPerformed: {ActionEvent evt ->
            (selectedItem) ? okAction.call(selectedItem) : okAction.call()
            closeAction.call()
        }] as IActionListener)
    }
